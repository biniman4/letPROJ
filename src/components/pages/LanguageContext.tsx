...
const translations = {
  am: {
    ...
    footer: {
      about: "ስለ SSGI",
      instituteOverview: "የተቋሙ አጠቃላይ እይታ",
      missionVision: "ራዕይ እና ተልዕኮ",
      contactUs: "ያግኙን",
      resources: "ምንጮች",
      ...
      location: "አካባቢ",
      instituteName: "የቦታ ሳይንስ እና ጂኦስፓሻል ኢንስቲትዩት (SSGI)",
      address: "አዲስ አበባ፣ ኢትዮጵያ",
      website: "www.ssgi.gov.et",
      copyright: "የቦታ ሳይንስ እና ጂኦስፓሻል ኢንስቲትዩት። መብት የተጠበቀ ነው።"
    },
    memo: {
      memoAmharic: "የዉስጥ ማስታወሻ",
      memoEnglish: "OFFICE MEMO",
      subject: "ጉዳይ",
      date: "ቀን"
    },
    userManagement: {
    ...
    letterManagement: {
      title: "የደብዳቤ አስተዳደር",
      subtitle: "የተጠቃሚ ደብዳቤዎችን ያስተዳድሩ፣ የተቀባ ደብዳቤዎችን ይግቡ፣ የተቀላቀሉ ደብዳቤዎችን ይመልከቱ",
      pendingApproval: "በመጠባበቅ ላይ ያሉ ደብዳቤዎች",
      rejectedLetters: "የተቀላቀሉ ደብዳቤዎች",
      totalLetters: "ጠቅላላ ደብዳቤዎች",
      showing: "በማሳየት ላይ:",
      pendingLetters: "በመጠባበቅ ላይ ያሉ ደብዳቤዎች",
      showAllLetters: "ሁሉንም ደብዳቤዎች አሳይ",
      pendingHighUrgent: "ከፍተኛ/አስቸኳይ ደብዳቤዎች",
      requireAdminApproval: "ለመላክ የአስተዳዳሪ ማጽደቅ ያስፈልጋል",
      pending: "በመጠባበቅ ላይ",
      from: "ከ:",
      to: "ወደ:",
      date: "ቀን:",
      ...
      approve: "አጽድቅ",
      reject: "አስወግድ",
      rejectedSubtitle: "የተቀላቀሉ ደብዳቤዎች ወደ ላኪው ተመልሰዋል",
      rejected: "ተቀላቀሉ",
      viewContent: "ይዘት አሳይ",
      allLetters: "ሁሉም ደብዳቤዎች",
      allLettersSubtitle: "ሁሉንም ደብዳቤዎች ይመልከቱ",
      searchBySubject: "በርዕስ ፈልግ...",
      letter: "ደብዳቤ",
      letters: "ደብዳቤዎች",
      letterDetails: "የደብዳቤ ዝርዝር",
      subject: "ርዕስ:",
      department: "መደብ:",
      priority: "ቅድሚያ:",
      attachments: "አባሪዎች:",
      download: "አውርድ",
      viewFullContent: "ሙሉ ይይዙ",
      close: "ዝጋ",
      priorityValues: {
        urgent: "አስቸኳይ",
        high: "ከፍተኛ",
    ...
    departments: {
      "Director General": "ዋና ዳይሬክተር",
      "Head of Office": "የቢሮ ኃላፊ",
      "Public Relations Executive": "የህዝብ ግንኙነት ኃላፊ",
      "Chief Executive Officer of Operations Management": "ዋና ስራ አስኪያጅ ስራዎች አስተዳደር",
      "Strategic Affairs Executive": "የStratejik ጉዳዮች ኃላፊ"
    },
    employees: {
      ccLabel: "ማቅረቢያ (CC)",
      confidential: "የሚያውቁት ብቻ",
      ccDescription: "ተመረጡ ሰራተኞች የዚህን ደብዳቤ ቅጂ በኢሜይል ይቀበላሉ። ኢሜዩ የመላክ ገደቦችን እና የግላዊነት ማስታወቂያዎችን ይዟል።"
    },
  },
  en: {
    // Home Page translations
    ...
    footer: {
      ...
      location: "LOCATION",
      instituteName: "Space Science and Geospatial Institute (SSGI)",
      address: "Addis Ababa, Ethiopia",
      website: "www.ssgi.gov.et",
      copyright: "Space Science and Geospatial Institute. All rights reserved."
    },
    memo: {
      memoAmharic: "የዉስጥ ማስታወሻ",
      memoEnglish: "OFFICE MEMO",
    ...
    letterManagement: {
      ...
      subtitle: "Manage user letters, view received and rejected letters",
      pendingApproval: "Pending Approval Letters",
      rejectedLetters: "Rejected Letters",
      totalLetters: "Total Letters",
      showing: "Showing:",
      pendingLetters: "Pending Letters",
      showAllLetters: "Show All Letters",
      pendingHighUrgent: "High/Urgent Letters",
      requireAdminApproval: "Admin approval required to send",
      pending: "Pending",
      from: "From:",
      to: "To:",
      date: "Date:",
      ...
      approve: "Approve",
      reject: "Reject",
      rejectedSubtitle: "Rejected letters have been returned to the sender",
      rejected: "Rejected",
      viewContent: "View Content",
      allLetters: "All Letters",
      allLettersSubtitle: "View all letters",
    ...
    departments: {
      ...
      "Chief Executive Officer of Operations Management": "Chief Executive Officer of Operations Management",
      "Strategic Affairs Executive": "Strategic Affairs Executive"
    },
    employees: {
      ccLabel: "CC (Carbon Copy)",
      confidential: "Confidential",
      ccDescription: "Selected employees will receive a confidential copy of this letter via email. The email will include forwarding restrictions and confidentiality notices."
    },
  },
};
