  ...
  return (
    <div>
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold text-gray-800">{t.title[lang]}</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              >
                <option value="">{lang === 'am' ? 'የመደብ ምረጥ' : 'Select Department'}</option>
          ...
          {/* Subject */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">{t.subject[lang]}</label>
            <input
              type="text"
          ...
          {/* To */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">{t.to[lang]}</label>
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          ...
          {/* Priority */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">{t.priority[lang]}</label>
              ...
              {['normal', 'high', 'urgent'].map(priority => (
                <label key={priority} className="inline-flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-700 capitalize">
                    {lang === 'am'
                      ? priority === 'normal' ? 'መደበኛ' : priority === 'high' ? 'ከፍተኛ' : 'አስቸኳይ'
                      : priority}
                  </span>
                </label>
              ))}
          ...
          {/* Content */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">{t.content[lang]}</label>
            <textarea
              rows={6}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              placeholder={lang === 'am' ? 'የደብዳቤውን ይዘት ያስገቡ' : 'Enter letter content'}
          ...
          {/* Attachments */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">{t.attachments[lang]}</label>
          ...
          <div className="flex justify-between mt-6">
            ...
            <button type="button" className="bg-gray-200 text-gray-800 rounded-md px-4 py-2 flex items-center space-x-2">
